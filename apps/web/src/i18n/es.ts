...
export const es = {
  ...
  'settings.showDemoHelp':
    'Antes de empezar, la figura hace el ejercicio. Con «cuando sea nuevo» aparece solo si no lo has hecho antes, y en tus primeras sesiones.',
