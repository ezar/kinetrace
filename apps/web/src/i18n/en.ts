...
export const en: Record<TranslationKey, string> = {
  ...
  'settings.showDemoHelp':
    'Before you start, the figure does the exercise. "When it is new" shows it only for an exercise you have not done before, and through your first sessions.',
